...
function smlsubform($atts=array()){
	extract(shortcode_atts(array(
		...
		"showsubmit" => true,
		"submittxt" => 'Sign-up for Newsletter',
		"jsthanks" => false,
	...
	if ($showname) $return .= '<p class="sml_name"><label class="sml_namelabel" for="sml_name" style="display: none;">'.$nametxt.'</label><input class="sml_nameinput" placeholder="'.$nameholder.'" name="sml_name" type="text" value=""></p>';
	$return .= '<p class="sml_email"><label class="sml_emaillabel" for="sml_email" style="display:none;">'.$emailtxt.'</label><input class="sml_emailinput" name="sml_email" placeholder="'.$emailholder.'" type="text" value=""></p>';
